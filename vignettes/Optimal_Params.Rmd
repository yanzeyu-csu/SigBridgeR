...
setFuncOption(parallel = TRUE)
# * This equals to
# options(SigBridgeR.parallel = TRUE)
...
# ℹ [2025/11/07 08:44:07] Using parallel processing with 4 workers
#  Progress: ────────────────────────────────────────────────────────────────────────────────────────── 100%
...
# * To
# * Note that since `parallel = TRUE` was previously enabled, parallel computation will also be used here
scPP_res <- Screen(
  matched_bulk = matched_bulk,
  sc_data = sc_dataset,
  phenotype = matched_phenotype_data,
...
# ℹ [2025/11/07 08:53:46] Using parallel processing with 4 workers
#  Progress: ──────────────────────────────────────────────────────────────────────────────────────────────── 100%
