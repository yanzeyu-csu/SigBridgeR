...
Although this screening method has modest performance and memory consumption, it requires a long execution time; thus, it is recommended to run it in the background.
...
Now we use scAB, scPP, DEGAS and LP_SGL to screen cells.
