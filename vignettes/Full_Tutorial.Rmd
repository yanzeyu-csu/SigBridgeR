...
Here we provide some visualization methods for the screening results. Considering that many people have different needs for data visualization, `SigBridgR` hardly provides visualization (except for Fraction plot). We only provide the source code for reference.
